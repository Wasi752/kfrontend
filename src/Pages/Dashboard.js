...
function AdminDeshBoard() {
  ...
  return (
    <div className="w-full h-full">
      <div className="w-full h-[10%] flex bg-yellow-100">
        <div className="[w-10%] h-full bg-blue-100" >
          <img src="/header&footer/darsgah.png" alt="Book Stor" className="w-[25%] h-[10%] mt-1 ml-10" />
          <p className="text-lg text-left font-blod text-green-900 ml-8">Darus Salam</p>
